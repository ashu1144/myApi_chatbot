...
function App() {
  ...
  return (
  <div className=' grid grid-cols-5 h-[100vh] text-center text-white  max-sm:max-h-screen '>
    ...
    {/* main section */}
    <div className={`  ${isOpen? " max-sm:hidden col-span-4 " : "col-span-5 p-2 "}  col-span-4 bg-gradient-to-tl from-[#ed6aff] via-[#a684ff] to-[#4f39f6] transition-all duration-300 flex flex-col justify-center`}>
        <div>
          {/* header */}
